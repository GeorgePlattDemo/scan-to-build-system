...
A source may be current and still control only one layer or question. No document becomes universal authority merely because it is newer, detailed, or executable.
...
The physical machine/cell layer owns actual:
...
Research owns questions and evidence collection.
