# Intake Source Reconciliation Note

The source `STB-ENTRY-INTAKE-CONTRACT-0.1.md` at `GeorgePlattDemo/grok-file@2d80b5a7b0e7687c425e100bfa0ff3a833166d42` contains durable intake principles but embeds an earlier Stage-2 Store pin.

Current disposition: **ADMIT AFTER REWRITE**.

The working intake rules have been reconciled into `../../work/user-intake/README.md` using:
