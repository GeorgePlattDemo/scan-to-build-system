...
export const STATIC_ASSETS = Object.freeze({
  ...
  '/review-donors/system-build-base-8d8a9dd.html': HTML_FILE('browser/review-donors/system-build-base-8d8a9dd.html'),
  '/review-donors/stb-window-seat-space-utilization-0.7.4.html': HTML_FILE('browser/review-donors/stb-window-seat-space-utilization-0.7.4.html'),
  '/review-donors/stb-start-own-0.11.html': HTML_FILE('browser/review-donors/stb-start-own-0.11.html'),
  '/review-donors/stb-outdoor-build.html': HTML_FILE('browser/review-donors/stb-outdoor-build.html'),
  '/review-donors/stb-canonical-journey.js': JS('browser/review-donors/stb-canonical-journey.js'),
  '/review-donors/store-zero-canonical-doctrine.js': JS('browser/review-donors/store-zero-canonical-doctrine.js'),
  '/review-donors/stb-store-handoff-contract.js': JS('browser/review-donors/stb-store-handoff-contract.js'),
  '/review-donors/stb-outdoor-reference-authority-0.3.html': HTML_FILE('browser/review-donors/stb-outdoor-reference-authority-0.3.html'),
  '/review-donors/STB-OUTDOOR-ANGLED-FRAME-RESEARCH-DOSSIER-0.1.html': HTML_FILE('browser/review-donors/STB-OUTDOOR-ANGLED-FRAME-RESEARCH-DOSSIER-0.1.html'),
  '/review-donors/stb-outdoor-build-deck-0.1.html': HTML_FILE('browser/review-donors/stb-outdoor-build-deck-0.1.html'),
  '/review-donors/stb-start-own-0.10.html': HTML_FILE('browser/review-donors/stb-start-own-0.10.html'),
  '/review-donors/assets/project-tiles/start-your-own.webp': WEBP('browser/review-donors/assets/project-tiles/start-your-own.webp'),
  '/review-donors/assets/project-tiles/plywood-curvilinear-shapes.webp': WEBP('browser/review-donors/assets/project-tiles/plywood-curvilinear-shapes.webp'),
