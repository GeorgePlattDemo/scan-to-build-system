...
test('only allowlisted browser and shared assets are served', async (t) => {
  ...
  const allowed = [
    ...
    ['/ui/project-configurator.mjs', 'javascript'],
    ['/ui/project-renderer.mjs', 'javascript'],
    ...
    ['/domain/configurator.mjs', 'javascript'],
    ['/domain/class-runner.mjs', 'javascript'],
    ['/domain/alcove-engine.mjs', 'javascript'],
    ...
    ['/shared/alcove-rule.mjs', 'javascript'],
