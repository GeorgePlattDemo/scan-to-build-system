...
export async function loadPinnedStoreModules(root) {
  ...
  try {
    ...
    const required = [
      ...
      [store, 'estimateResolvedBoardPlan'],
      [store, 'evaluateJob'],
      [store, 'loadCatalog'],
      [store, 'loadObservations'],
      [pricing, 'estimateJob'],
      [pricing, 'estimateBoardSequence'],
      [pricing, 'spotEconomicsAssessment'],
      [pricing, 'ENGINE'],
      [pricing, 'CYCLE_MODEL'],
    ...
    return {
      ...
      modules: {
        ...
        estimateResolvedBoardPlan: store.estimateResolvedBoardPlan,
        ...
        estimateBoardSequence: pricing.estimateBoardSequence,
        spotEconomicsAssessment: pricing.spotEconomicsAssessment,
