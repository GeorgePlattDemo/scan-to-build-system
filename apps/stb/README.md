...
Exact Store pin for this candidate branch: `58f8019bc7502edade5c79871a4962898df3304c` (`GeorgePlattDemo/scan-to-build-store`, Store PR #9). Repin to the promoted Store main SHA before this System branch is merged.
...
Exact Store pin for this candidate branch: `58f8019bc7502edade5c79871a4962898df3304c` (`GeorgePlattDemo/scan-to-build-store`, Store PR #9).
