...
Exact Store pin for this candidate branch: `5112031324a8f8d287175a89c573c301ec92050a` (`GeorgePlattDemo/scan-to-build-store`, Store PR #9). Repin to the promoted Store main SHA before this System branch is merged.
...
Exact Store pin for this candidate branch: `5112031324a8f8d287175a89c573c301ec92050a` (`GeorgePlattDemo/scan-to-build-store`, Store PR #9).
