...
- broader SKU/inventory coverage;
- a special-order path for requirements not satisfied by local stock;
- additional bounded dimensional-machine capability;
- an initial sheet-processing machine with limited automation;
- a two-machine research cell once a useful bounded task is selected and the physical evidence supports it.
